...
senators_df = pd.read_csv('senators_info.csv', index_col=0, header=0)
senators_party_df = clean_party_affiliation(senators_df)
filtered_senators_df = clean_sentence_count(senators_party_df)
filtered_senators_df.to_csv('final_senators_info.csv', index=False)

representatives_df = pd.read_csv('representatives_info.csv', index_col = 0, header=0)
...
filtered_representatives_df.to_csv('final_representatives_info.csv', index=False)

politicians_df = pd.concat([filtered_senators_df, filtered_representatives_df], ignore_index=True)
politicians_df.to_csv('politicians_info_df.csv', index=False)